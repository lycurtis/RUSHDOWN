...
// AVR output compare register OCR1A. OCR2A = 250; // Timer interrupt will be generated when TCNT1==OCR1A
...
// AVR timer interrupt mask registerTIMSK2 = 0x02; // bit1: OCIE1A -- enables compare match interrupt
//Initialize avr counterTCNT2 = 0;
